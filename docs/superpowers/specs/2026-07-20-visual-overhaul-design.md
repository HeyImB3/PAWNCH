...
| Phase | Delivers |
|---|---|
| **V1** | Art Bible v2, master palette, painted ring kit, lighting system (glow/spotlight/reflections), rope physics, press-row flashbulbs, knockdown spotlight moment, upgraded CLASSIC arena |
